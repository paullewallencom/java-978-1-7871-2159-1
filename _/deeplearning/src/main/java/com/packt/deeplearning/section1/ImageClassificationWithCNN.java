...
public class ImageClassificationWithCNN {
    private final static Logger LOGGER = org.slf4j.LoggerFactory.getLogger(ImageClassificationWithCNN.class);

    private static int height = 100;
    private static int width = 100;
    private static int channels = 3;
    private static int numExamples = 80;
    ...
    public static void main(String[] args) throws IOException {
        ...
        File mainPath = new File(System.getProperty("user.dir"), "/src/main/resources/data/images/animals/");
        ...
        if (save) {
            ...
            ModelSerializer.writeModel(network,new File(basePath+"lenet.model"),true);
        }
