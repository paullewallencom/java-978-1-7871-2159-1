...
public class Classification {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        trainReader.initialize(new FileSplit(new ClassPathResource("data/classification/train.csv").getFile()));
        ...
        testReader.initialize(new FileSplit(new ClassPathResource("data/classification/test.csv").getFile()));
